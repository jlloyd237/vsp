# -*- coding: utf-8 -*-
"""Test script for asynchronous video stream processor (multi-processing, DirectShow camera interface).
"""
...
from vsp.processor import CameraStreamProcessorMP, AsyncProcessor
