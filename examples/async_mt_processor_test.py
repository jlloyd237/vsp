# -*- coding: utf-8 -*-
"""Test script for asynchronous video stream processor (multi-threading).
"""
...
from vsp.processor import CameraStreamProcessorMT, FileStreamProcessorMT, AsyncProcessor
