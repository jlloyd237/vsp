# -*- coding: utf-8 -*-
"""Test script for video stream processor (multi-threading).
"""
...
from vsp.processor import CameraStreamProcessorMP, FileStreamProcessorMP
from vsp.encoder import KeypointEncoder
from vsp.view import KeypointView


def main():
    with CameraStreamProcessorMP(
