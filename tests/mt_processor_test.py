# -*- coding: utf-8 -*-
"""Test script for video stream processor (multi-processing).
"""
...
from vsp.processor import CameraStreamProcessorMT, FileStreamProcessorMT
from vsp.encoder import KeypointEncoder
from vsp.view import KeypointView


def main():
    with CameraStreamProcessorMT(
